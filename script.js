const openButton=document.getElementById("openInvite"),opening=document.getElementById("opening"),invitation=document.getElementById("invitation"),weddingMusic=document.getElementById("weddingMusic");

openButton.addEventListener("click",()=>{
  // The tap itself is a user gesture, so mobile browsers allow the song to start here.
...
function updateCountdown(){
  let d=Math.max(0,targetDate-Date.now());
